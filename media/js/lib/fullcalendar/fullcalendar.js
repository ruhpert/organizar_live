 ...
 */
 ...
 $(window).load(function() {
 			...
 			Calendarium.createCalNavigation();
 });
(function($, undefined) {
...
function Header(calendar, options) {
	...
	function render() {
		...
		if (sections) {
			$("#cal-navigation").append(renderSection('center'));
			$("#cal-navigation").append(renderSection('left'));
			$("#cal-navigation").append(renderSection('right'));
				...
				console.log("BUTTON NAME " + buttonName);
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							var button = $(
								"<span class='button fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +
									(icon ?
...
var S_WEEK = "week";
var S_DAY = "day";
var MONTHS = [S_MONTH, S_WEEK, S_DAY];
...
function setViewClass(className) {
	...
	$.each(MONTHS, function() {
		var MONTH = "" + this;
		console.log("removing class \""+ MONTH + "\"");
		console.log("body ", body);
		if (body.hasClass(MONTH)) {
			body.removeClass(MONTH);
		}
		else {
